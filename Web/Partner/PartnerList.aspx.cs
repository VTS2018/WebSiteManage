...
{
    public partial class PartnerList : ManagePage
    {
        ...
        protected static string strPanxu = " PartnerID desc  ";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //组合查询条件
                string strCondition = " PartnerID>0 " + CombSqlTxt(this.keywords);
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            WebSiteData.Partner mdata = new WebSiteData.Partner();
            ...
            string pageUrl = Utils.CombUrlTxt("PartnerList.aspx", urlParamsPage, this.keywords, "__id__");
        ...
        protected string CombSqlTxt(string _keywords)
        {
            ...
            {
                strTemp.Append(" and Partnername like '%" + _keywords + "%'");//模糊查询
            }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("PartnerList.aspx", urlParams, txtKeywords.Text));
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (bl)
            {
                JscriptMsg("批量删除成功啦！", Utils.CombUrlTxt("PartnerList.aspx", urlParams, this.keywords), "Success");
        ...
        protected void btnSaveSort_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < this.rptList.Items.Count; i++)
            {
                ...
                if (!int.TryParse(((TextBox)rptList.Items[i].FindControl("txtStarLevel")).Text.Trim(), out sortId))
                {
                    sortId = 99;
                }
                bll.UpdateField(id, "StarLevel=" + sortId.ToString());
            }
            JscriptMsg("保存排序成功啦！", Utils.CombUrlTxt("PartnerList.aspx", urlParams, txtKeywords.Text), "Success");
        }
    }
}