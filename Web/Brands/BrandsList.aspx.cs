...
{
    public partial class BrandsList : ManagePage
    {
        ...
        protected static string strPanxu = " SortIndex desc,BrandsID asc  ";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //组合查询条件
                string strCondition = " BrandsID>0 " + CombSqlTxt(this.keywords);
        ...
        protected string CombSqlTxt(string _keywords)
        {
            ...
            {
                strTemp.Append(" and BrandsName like '%" + _keywords + "%'");//模糊查询
            }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("BrandsList.aspx", urlParams, txtKeywords.Text));
        }
